    ...
    >
      <defs>
        ...
        <linearGradient id="ha-teal" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#22d3a8" />
          <stop offset="1" stopColor="#10b981" />
        </linearGradient>
        <linearGradient id="ha-blue" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#599dff" />
          <stop offset="1" stopColor="#1f57db" />
        </linearGradient>
      </defs>

      {/* soft blobs */}
      <circle cx="360" cy="80" r="120" fill="#1f57db" opacity="0.25" />
      <circle cx="90" cy="300" r="90" fill="#10b981" opacity="0.18" />

      {/* connecting dashed line */}
      <path d="M150 130 C 230 160, 240 230, 320 250" stroke="#8ec0ff" strokeWidth="2.5" strokeDasharray="6 8" strokeLinecap="round" opacity="0.7" />
      ...
      <g transform="rotate(-6 120 150)">
        ...
        <rect x="98" y="92" width="100" height="10" rx="5" fill="#0f1f4b" opacity="0.85" />
      ...
      <g transform="rotate(5 320 250)">
        ...
        <rect x="248" y="296" width="60" height="14" rx="7" fill="url(#ha-blue)" />
      </g>

      {/* Match badge */}
      <g transform="translate(214 150)">
        <circle r="30" fill="url(#ha-teal)" />
      ...
      {/* small floating dots */}
      <circle cx="410" cy="170" r="6" fill="#22d3a8" />
      <circle cx="120" cy="40" r="5" fill="#8ec0ff" />
